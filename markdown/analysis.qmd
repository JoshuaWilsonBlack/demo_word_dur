...
Link to the preregistration goes here: [not yet in existence].
...
qb_words <- qb_words |>
  mutate(
    word_duration = ##### EXERCISE --- complete this line,
...
5. We will remove utterances whose speech rate is more than 2.5SD from the speaker's mean speech rate.
...
qb_words <- qb_words |> 
  filter(
    -str_detect(), # complete these lines
    -str_detect(), # Make sure you understand what the '-' is doing.
